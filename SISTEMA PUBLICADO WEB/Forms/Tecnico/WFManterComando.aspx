<%@ Page Title="" Language="C#" MaintainScrollPositionOnPostback="false" MasterPageFile="~/Mpage/MPTecnico.Master" AutoEventWireup="true" CodeBehind="WFManterComando.aspx.cs" Inherits="HomeControl.Forms.Tecnico.WFManterComando" %>
        ...
        <div class="pre-visualizacao">
            <div class="controle-um-inteiro">
                ...
                <div class="tela-simples">
                    <asp:Button ID="btnNovoComando" CssClass="a-toch-um-meio ativo" OnClick="btnNovo_Click" runat="server" Text="NOVO" />
                    <asp:Button ID="btnPesquisarControle" CssClass="a-toch-um-meio ativo" OnClick="btnPesquisar_Click" runat="server" Text="BUSCAR" />
                </div>
            </div>
        </div>
    </div>
    <div class="invisible" id="divCadastrarComando" runat="server">
        ...
        <div class="controle-um-meio controle-fim">
            ...
            <asp:DropDownList ID="ddlBotao" runat="server">
                ...
                <asp:ListItem Value="btn-touch-nulo">NULLO</asp:ListItem>
        </asp:DropDownList>
        </div>
        <div class="controle-um-meio controle-inicio">
            <p>Comando</p>
        ...
        <div class="controle-um-meio controle-inicio">
            <p>Consumo Energia W.Hora</p>
            <asp:TextBox ID="txtEnergia" runat="server"></asp:TextBox>
        </div>
        <div class="controle-um-meio controle-fim">
            <p>Consumo Agua L.Hora</p>
            <asp:TextBox ID="txtAgua" runat="server"></asp:TextBox>
        </div>
