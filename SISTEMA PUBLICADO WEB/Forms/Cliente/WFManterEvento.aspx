...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="tela-controle" runat="server">
        <label class="titulo">AGENDAMENTO</label>
        <asp:Button ID="btnSair" runat="server" Text="X" OnClick="btnSair_Click" CssClass="btn-touch-sair" />
        <asp:TextBox ID="txtHora" OnKeyPress="MascaraHora(this)" PlaceHolder="00:00" MaxLength="5" CssClass="txthora" runat="server"></asp:TextBox>
    ...
    <div class="tela-simples">
        <asp:Button CssClass="a-toch-dois-terco ativo" ID="btnGravar" OnClick="btnGravar_Click" runat="server" Text="GRAVAR" />
          <asp:Button CssClass="a-toch-um-terco ativo-vermelho" ID="btnDeletar" OnClick="btnDeletar_Click" runat="server" Text="DELETAR" />
