...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="inicio bloco-inteiro">
        ...
        <div class="grupo-botoes-center">
            ...
            <asp:Button ID="btnDeletar" CssClass="btn-deletar" runat="server" OnClick="btnDeletar_Click" Text="Deletar" />
            <asp:Button ID="btnBuscar" CssClass="btn-buscar" runat="server" OnClick="btnBuscar_Click" Text="Buscar" />
        </div>
    </div>
</asp:Content>
