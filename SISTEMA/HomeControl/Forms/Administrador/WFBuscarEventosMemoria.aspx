<%@ Page Title="" Language="C#" MasterPageFile="~/Mpage/MPAdministrador.Master" AutoEventWireup="true" CodeBehind="WFBuscarEventosMemoria.aspx.cs" Inherits="HomeControl.Forms.Administrador.WFBuscarEventosMemoria" %>
    ...
    <div class="inicio bloco-inteiro">
        ...
        <asp:GridView ID="gvPesquisarEventos" CssClass="grid-justificado" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" AutoGenerateColumns="False" DataKeyNames="Id">
            <Columns>
                ...
                <asp:BoundField DataField="Texto" HeaderText="Comando" />
                <asp:BoundField DataField="ObjDispositvo.Id" HeaderText="Dispositivo" />                
                <asp:BoundField DataField="ObjAgenda.Id" HeaderText="Agenda" />
